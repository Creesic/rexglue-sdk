 ...
 *
 * Ported from the plume fork (scripts/fm2 smoke harness) so DOAX can be driven
 * headlessly: controller state is read from a text file named by the
 * REX_AUTOMATION_GAMEPAD_FILE env var (packet/buttons/triggers/thumbsticks),
 * letting a script inject Start/A taps and screenshot-classify the result.
 ******************************************************************************
 */
