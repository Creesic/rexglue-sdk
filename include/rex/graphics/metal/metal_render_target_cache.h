...
class MetalRenderTargetCache final : public ::rex::graphics::RenderTargetCache {
 public:
 ...
 public:
  ...
  bool PrepareResolvePlan(memory::Memory& memory, ResolvePlan& plan_out);
  bool Resolve(memory::Memory& memory, uint32_t& written_address,
