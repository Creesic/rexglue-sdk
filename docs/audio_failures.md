...
Resolved baseline (May 30, 2026):
- FM2 audio is now confirmed clean/perfect when FM2 is forced onto the XAudio2 backend via `Fm2App::OnPreSetup`.
- This file remains the FMOD-path failure history and speculative queue.
